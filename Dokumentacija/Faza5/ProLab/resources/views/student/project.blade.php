        ...
        <div class="col-12 tabs d-flex align-bottom  nav nav-tabs justify-content-start pt-4" id="nav-div">
            <nav class="">
                <div clsas="d-flex align-self-end" class="nav">
                    <a href="#" class="project-tab-button active nav-item ml-3 mr-1 nav-link btn-outline-dark" data-tab-id="#project-info">O projektu</a>
                    <a href="#" class="project-tab-button nav-item mr-1 nav-link btn-outline-dark" data-tab-id="#team-list">Dostupni timovi</a>
