    ...
    <div class="row ml-5 mr-5">
        ...
        <div class="col-10 pt-5">
            @if(count($newSubjectRequests) > 0)
                <table class="table table-borderless table-striped mytable" id="subject_requests">
                    <tr>
                        <th>#</th>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Da li zaista želite da prihvatite zahtev za kreiranje predmeta?
                                            </div>
                                ...
                                <div class="modal fade" id="{{ 'modal2'.$newSubjectRequests[$i]->idRequest }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Da li zaista želite da odbijete zahtev za kreiranje predmeta?
                                            </div>
                                            <div class="modal-footer">
